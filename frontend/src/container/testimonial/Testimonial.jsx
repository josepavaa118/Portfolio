      ...
      {testimonials.length > 0 && testimonials[currentIndex] && (
        <div className="app__testimonial-wrapper">
          ...
          <div className="app__testimonial-btns app__flex">
            <div className="app__testimonial-btn" onClick={() => handleClick(currentIndex === 0 ? testimonials.length - 1 : currentIndex - 1)}>
              <HiChevronLeft />
            </div>
            <div className="app__testimonial-btn" onClick={() => handleClick(currentIndex === testimonials.length - 1 ? 0 : currentIndex + 1)}>
              <HiChevronRight />
            </div>
          </div>
        </div>
